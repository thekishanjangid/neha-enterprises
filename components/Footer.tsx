...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-white/5 bg-bg-dark">
      ...
      <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-brand-primary via-brand-purple to-brand-secondary" />
      ...
      <div className="mx-auto max-w-[1400px] px-5 py-16 lg:px-12 lg:py-20">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-1">
            ...
            <div className="mt-6 flex items-center gap-3">
              <a href={BUSINESS.instagram} target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 text-white/40 transition-all duration-300 hover:border-brand-primary/50 hover:text-brand-primary hover:bg-brand-primary/10" aria-label="Instagram">
              ...
              <a href={BUSINESS.facebook} target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 text-white/40 transition-all duration-300 hover:border-brand-primary/50 hover:text-brand-primary hover:bg-brand-primary/10" aria-label="Facebook">
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 sm:flex-row">
          ...
          <p className="text-xs text-white/20">Crafted with precision in Jaipur, Rajasthan</p>
        </div>
      </div>
      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="fixed bottom-24 right-5 z-40 flex h-10 w-10 items-center justify-center rounded-full border border-border-light bg-white shadow-[0_4px_20px_rgba(0,0,0,0.08)] text-text-secondary transition-all duration-300 hover:gradient-brand hover:text-white hover:border-transparent hover:shadow-[0_4px_20px_rgba(123,45,184,0.25)] md:bottom-8 group/scroll"
